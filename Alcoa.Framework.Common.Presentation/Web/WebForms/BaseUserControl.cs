            ...
            get
            {
                try
                {
                    if (_appUser == null)
                    {
                        if (UserClaims == null)
                        {
                            _appUser = new BaseEmployee { NameOrDescription = HttpContext.Current.User.Identity.Name };
                        }
                        else
                        {
            ...
            get
            {
                try
                {
                    if (HttpContext.Current.User != null &&
                        ...
                        HttpContext.Current.User.Identity is IClaimsIdentity)
                        return ((IClaimsIdentity)HttpContext.Current.User.Identity).Claims;
                }
                catch (Exception ex)
                {
                    throw new PresentationException(CommonExceptionType.AppInitializationException, ex.GetAllExceptionMessages());
